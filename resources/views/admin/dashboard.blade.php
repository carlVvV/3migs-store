...
@section('title', 'Admin Dashboard - 3Migs Barong')
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $stats['total_products'] ?? \App\Models\BarongProduct::count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $stats['total_users'] ?? \App\Models\User::where('role', '!=', 'admin')->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
