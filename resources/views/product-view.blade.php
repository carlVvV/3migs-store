                    ...
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <button type="button" onclick="openSizeChart()" 
                                    class="text-sm text-blue-600 hover:text-blue-800 flex items-center underline">
...
function createOrGetSizeChartModal() {
    ...
    modal.innerHTML = `
        <div class="absolute inset-0 bg-black bg-opacity-50" onclick="closeSizeChart()"></div>
        <div class="absolute inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <div class="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                    <h2 class="text-2xl font-bold text-gray-900">Size Guide</h2>
                    <button onclick="closeSizeChart()" class="text-gray-500 hover:text-gray-700">
                ...
                <div class="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end">
                    <button onclick="closeSizeChart()" class="px-6 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors">
                        Close
                    </button>
                </div>
            </div>
